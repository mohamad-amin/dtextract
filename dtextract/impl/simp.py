...
class InternalNode:
    ...
    def __lt__(self, other):
        return self.thresh < other.thres
...
def genAxisAligned(func, dist, cons, params):
    ...
    dtInternal = dtConstructor(max_depth=1, min_impurity_decrease=0.0)
    ...
    val = list(yPreds)[0]
    assert np.allclose(list(yPreds), [val] * len(yPreds))  # Todo: check this
